// Phase 1 morning relationship brief -- Claude assembly client.
// Mirrors src/lib/claude/draft-client.ts: same Anthropic init, same withRetry,
// same ephemeral system-prompt caching. Different voice and output contract.
//
// Model: claude-sonnet-4-6. max_tokens: 1500.
// Voice: smart colleague briefing Alex pre-coffee, not a database report.
// Output: markdown sections only, no preamble, no closing pleasantry.
...
export async function assembleBrief(input: BriefInput): Promise<BriefResult> {
