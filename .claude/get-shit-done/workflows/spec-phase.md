...
```bash
INIT=$(node "/Users/alex/crm/.claude/get-shit-done/bin/gsd-tools.cjs" init phase-op "${PHASE}")
...
Use the SPEC.md template from @/Users/alex/crm/.claude/get-shit-done/templates/spec.md.
