...
<required_reading>
@/Users/alex/crm/.claude/get-shit-done/references/domain-probes.md
@/Users/alex/crm/.claude/get-shit-done/references/gate-prompts.md
@/Users/alex/crm/.claude/get-shit-done/references/universal-anti-patterns.md
</required_reading>
...
- Read and execute @/Users/alex/crm/.claude/get-shit-done/workflows/discuss-phase-power.md end-to-end
...
```bash
PROFILE_CONTENT=$(cat "/Users/alex/crm/.claude/get-shit-done/USER-PROFILE.md" 2>/dev/null || true)
```
...
2. For EACH user-selected gray area, spawn a Task() in parallel:
   ...
   Task(
     prompt="First, read @/Users/alex/crm/.claude/agents/gsd-advisor-researcher.md for your role and instructions.
...
**Full step-by-step instructions:** @/Users/alex/crm/.claude/get-shit-done/workflows/discuss-phase-power.md
