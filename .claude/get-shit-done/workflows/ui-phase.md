...
```markdown
Read /Users/alex/crm/.claude/agents/gsd-ui-researcher.md for instructions.
...
Template: /Users/alex/crm/.claude/get-shit-done/templates/UI-SPEC.md
</output>
...
```markdown
Read /Users/alex/crm/.claude/agents/gsd-ui-checker.md for instructions.
