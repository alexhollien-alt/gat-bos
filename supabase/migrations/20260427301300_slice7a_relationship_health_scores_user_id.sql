-- Slice 7A Task 0b-suppl-13 -- relationship_health_scores.user_id add-column (forward, idempotent)
...
--   SELECT count(*) FROM public.relationship_health_scores WHERE user_id IS NULL;  -- expect 0
--   SELECT column_default FROM information_schema.columns
--    WHERE table_schema='public' AND table_name='relationship_health_scores' AND column_name='user_id';
--   -- expect 'auth.uid()'
